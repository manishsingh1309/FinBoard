  ...
  return (
    <>
        ...
        <CardHeader className="flex-row items-start justify-between gap-3 pb-3 relative">
          ...
          <div className="flex items-center gap-1.5 opacity-100 transition-opacity">
            ...
            <Button
              ...
              className="size-9 text-red-500 hover:text-red-600 hover:bg-red-500/20 finboard-focus transition-colors"
            >
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent className="bg-[color:var(--color-popover)] border-[color:var(--color-border)]">
          <AlertDialogHeader>
            <AlertDialogTitle className="text-[color:var(--color-popover-foreground)]">Delete Widget?</AlertDialogTitle>
            <AlertDialogDescription className="text-[color:var(--color-muted-foreground)]">
              Are you sure you want to delete <strong>"{widget.name}"</strong>? This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel className="border-[color:var(--color-border)] text-[color:var(--color-foreground)]">
              Cancel
            </AlertDialogCancel>
            <AlertDialogAction 
